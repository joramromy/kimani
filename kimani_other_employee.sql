...
--
-- Table structure for table `authentication_other_employee`
--

CREATE TABLE `authentication_other_employee` (
...
--
-- Indexes for table `authentication_other_employee`
--
ALTER TABLE `authentication_other_employee`
...
--
-- AUTO_INCREMENT for table `authentication_other_employee`
--
ALTER TABLE `authentication_other_employee`
