...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2024 at 02:52 PM
...
--
-- Database: `kimani_site-managers`
--

-- --------------------------------------------------------

--
-- Table structure for table `authenticationsitemanager`
--

CREATE TABLE `authenticationsitemanager` (
...
--
-- Indexes for table `authenticationsitemanager`
--
ALTER TABLE `authenticationsitemanager`
...
--
-- AUTO_INCREMENT for table `authenticationsitemanager`
--
ALTER TABLE `authenticationsitemanager`
