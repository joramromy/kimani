...
(1, 'joram', 'joram gwamaka', '', 'Male', 678721526, 'joramgwamaka@gmail.com', 'romezinho10', 'romezinho10', '', '2024-07-20 18:10:35');
...
--
-- Table structure for table `authenticationfinance`
--

CREATE TABLE `authenticationfinance` (
  `Login_id` int(20) NOT NULL,
  `username` varchar(20) NOT NULL,
  `full_name` varchar(20) NOT NULL,
...
--
-- Table structure for table `authenticationi.t`
--

CREATE TABLE `authenticationi.t` (
  `Login_id` int(20) NOT NULL,
  `username` varchar(20) NOT NULL,
  `full_name` varchar(200) NOT NULL,
  `age` varchar(200) NOT NULL,
...
INSERT INTO `messages` (`id`, `group_id`, `sender`, `message`, `attachment_path`, `created_at`) VALUES
(2, 1, 'User1', 'joram', NULL, '2024-07-26 02:00:47'),
(3, 1, 'User1', 'hellow', NULL, '2024-07-26 02:01:41');
...
--
-- Indexes for table `authenticationi.t`
--
ALTER TABLE `authenticationi.t`
  ADD PRIMARY KEY (`Login_id`);
...
--
-- AUTO_INCREMENT for table `authenticationi.t`
--
ALTER TABLE `authenticationi.t`
  MODIFY `Login_id` int(20) NOT NULL AUTO_INCREMENT;
