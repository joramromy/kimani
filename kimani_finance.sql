...
--
-- Dumping data for table `authenticationfinance`
--

INSERT INTO `authenticationfinance` (`Login_id`, `username`, `full_name`, `age`, `gender`, `Phone`, `email`, `Password`, `comfirm_password`, `reset_token`, `token_expiry`) VALUES
(1, 'joram', 'joram gwamaka', '', 'Male', 678721526, 'joramgwamaka@gmail.com', 'romezinho10', 'romezinho10', '', '2024-07-31 11:15:45');
...
--
-- Indexes for table `authenticationfinance`
--
ALTER TABLE `authenticationfinance`
...
--
-- AUTO_INCREMENT for table `authenticationfinance`
--
ALTER TABLE `authenticationfinance`
