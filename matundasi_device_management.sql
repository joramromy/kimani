...
--
-- Database: `matundasi_device_management`
--
...
--
-- AUTO_INCREMENT for table `all_staff`
--
ALTER TABLE `all_staff`
...
--
-- Constraints for table `all_staff`
--
ALTER TABLE `all_staff`
  ADD CONSTRAINT `all_staff_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`);

--
-- Constraints for table `assigned`
--
ALTER TABLE `assigned`
  ADD CONSTRAINT `assigned_deviceid` FOREIGN KEY (`assigned_useid`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`),
  ADD CONSTRAINT `assigned_useid` FOREIGN KEY (`assigned_useid`) REFERENCES `all_staff` (`userid`);

--
-- Constraints for table `devices`
--
ALTER TABLE `devices`
  ADD CONSTRAINT `userid` FOREIGN KEY (`userid`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`);

--
-- Constraints for table `handover`
--
ALTER TABLE `handover`
  ADD CONSTRAINT `handover_deviceid` FOREIGN KEY (`handover_useid`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`),
  ADD CONSTRAINT `handover_useid` FOREIGN KEY (`handover_useid`) REFERENCES `all_staff` (`userid`);

--
-- Constraints for table `request`
--
ALTER TABLE `request`
  ADD CONSTRAINT `request_ibfk_1` FOREIGN KEY (`call_userid`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`Employee_Number`) REFERENCES `matundasi`.`authenticationprocurement` (`Login_id`);
COMMIT;
